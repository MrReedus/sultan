...
function Filter() {
  return (
    <aside class="catalog__filter filter">
      ...
      <h3 class="filter__subtitle">Производитель</h3>
      ...
      <div class="filter__brands">
        ...
        <label for="bulfarry">
          {" "}
          <input type="checkbox" id="bulfarry" />
          <span>Булгари Грин</span>
        </label>
      </div>
      <div class="filter__popup-btn">
        <span class="filter__show">Показать все</span>
      ...
      <div class="filter__brands">
        ...
        <label for="Paclan">
          {" "}
          <input type="checkbox" id="Домашний сундук" />
          <span>Домашний сундук</span>
        </label>
      ...
      <div class="filter__buttons filter-buttons">
