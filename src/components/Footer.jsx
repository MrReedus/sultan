    ...
    <footer class="footer">
      <div class="footer__container">
        <div class="footer__col">
          ...
          <p className="footer__subscription">Подпишись на скидки и акции</p>
          <div className="footer__search search">
            <input type="text" placeholder="Введите ваш E-mail" />
            <div className="search__image">
              <svg width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0 13.7143L5.625 8L0 2.28571L1.125 0L9 8L1.125 16L0 13.7143Z" fill="#FFF" />
              </svg>
            </div>
          </div>
        </div>
        <div class="footer__col footer-column">
          <h2>Меню сайта:</h2>
          <ul>
            <li>
              <a href="">О компании</a>
        ...
        <div class="footer__col footer-column">
          ...
          <p className="footer__subtitle"> Связь в мессенджерах:</p>
          <div class="footer__contacts-social">
            ...
            <svg width="39" height="39" viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clip-path="url(#clip0_7426_387)">
                <path
